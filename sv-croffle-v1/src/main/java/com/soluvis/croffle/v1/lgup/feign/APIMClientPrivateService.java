...
/**
 * 클래스 설명	: APIM Private 존 관련
 * @Class Name 	: APIMClientPrivateService
 * @date   		: 2024. 1. 2.
 * @author   	: Kriverds
 * @version		: 1.0
 * ----------------------------------------
 ...
 * 
 */
@FeignClient(name = "APIMClientPrivateService", url = "${apim.pv.url}", configuration = APIMFeignServiceHeaderConfig.class)
